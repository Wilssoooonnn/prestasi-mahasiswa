...
<!-- Modal pertama untuk data kompetisi -->
<form action="<?= BASE_URL; ?>mahasiswa/insertKompetisi" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#insertModal2">Next</button>
                </div>
            </div>
        </div>
    </div>
...
<!-- Modal kedua untuk upload berkas -->
<form action="<?= BASE_URL; ?>mahasiswa/insertKompetisi" method="post" enctype="multipart/form-data">
    <div class="modal fade" id="insertModal2" tabindex="-1" aria-labelledby="insertModalLabel2" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- Input File fields here (file_surat_tugas, foto_kegiatan, dll) -->
                    <form>
                        <div class="position-relative m-4">
                            <div class="progress" style="height: 1px;">
                                <div class="progress-bar" role="progressbar" style="width: 50%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#insertModal">Back</button>
                    <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#insertModal3">Next</button>
                </div>
            </div>
        </div>
    </div>
...
<!-- Modal ketiga untuk data mahasiswa -->
<form action="<?= BASE_URL; ?>mahasiswa/insertKompetisi" method="post">
    <div class="modal fade" id="insertModal3" tabindex="-1" aria-labelledby="insertModalLabel3" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="insertModalLabel3">Data Mahasiswa</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <!-- Input mahasiswa fields (nim, full_name, alamat, email) -->
                    <form>
                        <div class="position-relative m-4">
                            <div class="progress" style="height: 1px;">
                                <div class="progress-bar" role="progressbar" style="width: 50%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#insertModal2">Back</button>
                    <button type="submit" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#insertModal3">Save</button>
                </div>
            </div>
        </div>
    </div>
