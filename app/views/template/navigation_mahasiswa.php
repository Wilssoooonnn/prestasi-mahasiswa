...
<div class="bg-light p-3 vh-100" id="sidebar" style="width: 250px;">
    ...
    <ul class="nav flex-column">
        <li class="nav-item">
            <a href="<?= BASE_URL; ?>mahasiswa/dashboard" class="nav-link d-flex align-items-center">
                <i class="fi fi-rr-house-blank"></i> <span class="ms-3">Home</span>
            </a>
        </li>
        <li class="nav-item">
            <a href="<?= BASE_URL; ?>mahasiswa/profile" class="nav-link d-flex align-items-center">
                <i class="fi fi-rr-user"></i> <span class="ms-3">Profile</span>
            </a>
        </li>
        <li class="nav-item">
            <a href="<?= BASE_URL; ?>mahasiswa/setting" class="nav-link d-flex align-items-center">
                <i class="fi fi-rr-settings-sliders"></i> <span class="ms-3">Settings</span>
            </a>
        </li>
        <li class="nav-item">
            <a href="<?= BASE_URL; ?>mahasiswa/kompetisi" class="nav-link d-flex align-items-center">
                <i class="fi fi-rr-trophy-star"></i> <span class="ms-3">Kompetisi</span>
            </a>
        </li>
        <li class="nav-item">
            <a href="<?= BASE_URL; ?>mahasiswa/help" class="nav-link d-flex align-items-center">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownProfile">
                            ...
                            <li><a class="dropdown-item" href="<?= BASE_URL; ?>mahasiswa/setting">Settings</a></li>
